...
<div class="item_main_info <?=(!$showCustomOffer ? "noffer" : "");?> <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>" id="<?=$arItemIDs["strMainID"];?>">
    <div class="row">
	<div class="img_wrapper swipeignore col-md-12">
		<div class="stickers">
		...
		<div class="item_slider">
							...
							<?if($arParams["DISPLAY_COMPARE"] == "Y"):?>
								...
								<?elseif($arResult["OFFERS"] && $arParams["TYPE_SKU"] === 'TYPE_1'):?>
									<div data-item="" data-iblock="<?=$arResult["IBLOCK_ID"]?>" data-href="<?=$arResult["COMPARE_URL"]?>" class="compare_item text <?=$arParams["TYPE_SKU"];?>">
										<span class="ff value" title="<?=GetMessage('CT_BCE_CATALOG_COMPARE')?>"><i></i></span>
										<span class="value added" title="<?=GetMessage('CT_BCE_CATALOG_COMPARE_ADDED')?>"><i></i></span>
									</div>
								<?endif;?>
							<?endif;?>
            ...
            <style>
                .catalog_detail.detail.element_2 .item_main_info .item_slider .slides ul li {
                    position: relative;
                    height: 300px;
                ...
                .right_block .slides ul li:before{
                   display:none;
                }
...
.sidepic {
    font-size: 26px;
                ...
                .ribbon {
                    ...
                    text-align: center;
                    line-height: 30px;
                    -webkit-transform: translate3d(40px, 40px, 0) rotate(45deg) scale(1);
                    transform: translate3d(83px, 5px, 0) rotate(45deg) scale(1);
                   /* -webkit-animation-name: rotatedScalingSlideIn;
                    animation-name: rotatedScalingSlideIn;
                ...
                @-webkit-keyframes rotatedScalingSlideIn {
                    0% {
                        -webkit-transform: translate3d(-100px, -100px, 0) rotate(45deg) scale(0);
                        transform: translate3d(-100px, -100px, 0) rotate(45deg) scale(0);
                    }
                    100% {
                        -webkit-transform: translate3d(40px, 40px, 0) rotate(45deg) scale(1);
                        transform: translate3d(40px, 40px, 0) rotate(45deg) scale(1);
                    }
                }

                @keyframes rotatedScalingSlideIn {
                    0% {
                        -webkit-transform: translate3d(-100px, -100px, 0) rotate(45deg) scale(0);
                        transform: translate3d(-100px, -100px, 0) rotate(45deg) scale(0);
                    }
					...
					if($arResult["MORE_PHOTO"]){
						...
						<ul>
                            <?foreach($arResult["MORE_PHOTO"] as $i => $arImage){
								...
								$title=$arImage["TITLE"];
								?>
								<li id="photo-<?=$i?>" <?=(!$i ? 'class="current"' : 'style="display: block;"')?>>
                                    <?if ($arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'reklamnye-shchity-3kh6' || $arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'supersayty' || $arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'siti-format' || $arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'pilony' and $arResult['ID'] != '22966' and $arResult['ID'] != '23169'):?>

                                        <div class='screen'>
                                            <div class='ribbon'><span class="sidepic"><?=$i==0?"А":"Б";?></span></div>
                                        </div>
                                    <?endif;?>
							...
							<ul class="slides_block" id="thumbs">
                                <?foreach($arResult["MORE_PHOTO"]as $i => $arImage):?>
									<li <?=(!$i ? 'class="current"' : '')?> data-big_img="<?=$arImage["BIG"]["src"]?>" data-small_img="<?=$arImage["SMALL"]["src"]?>">
                                        <span><img class="xzoom-gallery" onclick="alex()" width="50" xpreview="<?=$arImage["THUMB"]["src"];?>" src="<?=$arImage["THUMB"]["src"]?>" alt="<?=$arImage["ALT"];?>" title="<?=$arImage["TITLE"];?>" /></span>
                                    </li>
								<?endforeach;?>
							</ul>
    ...
    .pad.cur{
        color:red;
                        ...
                        <?if ($arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'reklamnye-shchity-3kh6' || $arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'supersayty' || $arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'siti-format' || $arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'pilony' and $arResult['ID'] != '22966' and $arResult['ID'] != '23169'):?>
                            ...
                            <span class="pad cur" style="position: relative;left: -26px;">A</span><span class="pad" style="position: relative;right: -25px;">Б</span>
                        <?endif;?>
                        <?if ($arResult["ORIGINAL_PARAMETERS"]["SECTION_CODE"] == 'reklamnye-tumby'):?>

                            <span style="position: relative;left: -52px;">A</span><span style="position: relative;right: 0px;">Б</span><span style="position: relative;right: -51px;">С</span>
                        <?endif;?>
...
<?if($arResult['ID'] == '22966'):?>
    <span style="position: relative;left: -23px;">A1</span><span style="position: relative;right: -23px;">Б1</span>
<?endif;?>
                        <?if($arResult['ID'] == '23169'):?>
                            <span style="position: relative;left: -23px;">A2</span><span style="position: relative;right: -23px;">Б2</span>
                        <?endif;?>
	...
	<div class="right_info col-md-12">
		<div class="info_item">
	...
	<?if($arResult["DETAIL_TEXT"] || $showProps):
		...
		<div class="row">
			<?if($arResult["DETAIL_TEXT"]):?>
				<div class="col-md-<?=$class;?> detail-text-info">
                                ...
                                <div class="props_block" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['DISPLAY_PROP_DIV']; ?>">
									<?foreach($arResult["PROPERTIES"] as $propCode => $arProp):?>
										<?if(isset($arResult["DISPLAY_PROPERTIES"][$propCode])):?>
											...
											<?if(!in_array($arProp["CODE"], array("GPS","SERVICES", "BRAND", "HIT", "RECOMMEND", "NEW", "STOCK", "VIDEO", "VIDEO_YOUTUBE", "CML2_ARTICLE"))):?>
								...
								<div class="char_block">
									<table class="props_list">
										<?foreach($arResult["DISPLAY_PROPERTIES"] as $arProp):?>
											<?if(!in_array($arProp["CODE"], array("SERVICES", "BRAND", "HIT", "RECOMMEND", "NEW", "STOCK", "VIDEO", "VIDEO_YOUTUBE", "CML2_ARTICLE","GPS"))):?>
												<?if((!is_array($arProp["DISPLAY_VALUE"]) && strlen($arProp["DISPLAY_VALUE"])) || (is_array($arProp["DISPLAY_VALUE"]) && implode('', $arProp["DISPLAY_VALUE"]))):?>
...
<div class="mobile-table-wrapper">
	<table class="colored_table colored_table_object"> <?/*offers_table*/?>
					<thead>
						<tr>
							<?if($useStores):?>
								<td class="str"></td>
									...
									<!--noindex-->
										...
										<?if($arskuAddToBasketData["ACTION"] == "ADD"):?>
											<?if($arskuAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_DETAIL"] && !count($arSKU["OFFERS"]) && $arskuAddToBasketData["ACTION"] == "ADD" && $arskuAddToBasketData["CAN_BUY"]):?>
												<td class="counter_wrapp counter_block_wr" style="display: none;">
										...
										<?}?>
										<td class="buy hh" <?=($arskuAddToBasketData["ACTION"] !== "ADD" || !$arskuAddToBasketData["CAN_BUY"] || $arParams["SHOW_ONE_CLICK_BUY"]=="N" ? 'colspan="3"' : "")?>>
    ...
    <div><?=$arResult["DISPLAY_PROPERTIES"]['GPS']['DISPLAY_VALUE']?></div>
